    ...
    public function run(): void
    {
        $categories = [
            ...
            [
                ...
                'name_en' => 'Society',
                'slug' => 'society', 
                'description_bn' => 'সামাজিক বিষয় ও সমস্যা',
                'description_en' => 'Social issues and problems',
                'icon' => 'people',
                'color' => '#10B981',
                'sort_order' => 3,
            ],
            ...
            [
                ...
                'name_en' => 'Culture',
                'slug' => 'culture',
                'description_bn' => 'সাংস্কৃতিক ঐতিহ্য ও শিল্প',
                'description_en' => 'Cultural heritage and arts',
                'icon' => 'palette',
                'color' => '#8B5CF6',
                'sort_order' => 5,
            ],
